    ...
    >
      ...
      <div className="hero-content text-neutral-content text-center">
        <div className="max-w-lg">
          ...
          <button className="absolute bg-[#797DFC] btn btn-sm rounded-2xl md:rounded-3xl px-2 md:px-8 text-white top-0 md:top-1 right-0 md:right-1 text-xs md:text-base h-4 md:h-10">Search</button>
        </div> 
